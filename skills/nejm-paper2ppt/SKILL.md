---
name: nejm-paper2ppt
description: Build editable English NEJM-style PPTX journal-club or teaching decks from patient-oriented medical papers, trials, guidelines, systematic reviews, diagnostic/prognostic studies, AI-in-medicine papers, and GI/endoscopy/hepatology-adjacent research. Use when the user asks for medical evidence slides, Big Four/GI journal club, paper presentation, evidence appraisal deck, or AI-in-GI presentation. Default output language is English.
---

# NEJM-Style Paper to PPT
...
Open `references/nejm-deck-patterns.md` for slide archetypes and reporting guideline routing.
