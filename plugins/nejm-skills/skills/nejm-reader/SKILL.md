---
name: nejm-reader
description: Build English NEJM-style medical paper readers and appraisal notes from PDFs, DOIs, abstracts, trial reports, guidelines, systematic reviews, diagnostic/prognostic studies, and AI-in-medicine papers. Use when the user asks to read, appraise, summarize, or extract a patient-oriented medical paper with source grounding, PICO, endpoints, effect sizes, harms, bias, and practice implications. Default output language is English.
---

# NEJM-Style Reader

Use this skill to read patient-oriented medical papers as evidence for decisions, teaching, or manuscript planning.
...
Open `references/nejm-appraisal.md` when judging study quality or selecting reporting guidelines.
