---
name: nejm-writing
description: Draft, restructure, or plan NEJM-style medical manuscript sections for NEJM/JAMA/Lancet/BMJ/GI-style patient-oriented research, including titles, structured abstracts, introductions, methods, results, discussions, limitations, practice implications, cover letters, and reporting-guideline checklists. Use for trials, observational studies, diagnostic/prognostic studies, systematic reviews, guidelines, AI-in-medicine, and AI-in-GI manuscripts. Default output language is English.
---
...
Open `references/nejm-manuscript-patterns.md` for study-type routing and abstract/discussion patterns.
