---
name: nejm-figure
description: Create, revise, or audit NEJM-style medical research figures and tables for manuscripts, journal clubs, and patient-care presentations. Use for CONSORT/STROBE/PRISMA flow diagrams, Kaplan-Meier curves, forest plots, diagnostic accuracy, calibration, ROC/PR curves, decision curves, subgroup plots, trial timelines, harms tables, baseline tables, and AI-in-medicine model evaluation figures. Default output language is English.
---

# NEJM-Style Figure

Use this skill for medical research figures where interpretability and endpoint integrity matter more than decorative style.
...
Open `references/nejm-figure-patterns.md` for figure routing and QA checks.
